...
#      mkdir -p ~/bin && cp ci/entregar.sh ~/bin/entregar-lapublisher
#      chmod 755 ~/bin/entregar-lapublisher
#
#  E no ~/.ssh/authorized_keys, a chave da entrega entra assim:
#      restrict,command="/home/deploy/bin/entregar-lapublisher" ssh-ed25519 AAAA... entrega-lapublisher
#
...
PROJETO="/var/www/projetos/LA-Publisher"
TRAVA="/tmp/entregar-lapublisher.lock"
...
logger -t entrega-lapublisher "pedido de entrega de ${SSH_CLIENT%% *}"
...
logger -t entrega-lapublisher "entrega terminou com código $CODIGO"
exit $CODIGO
